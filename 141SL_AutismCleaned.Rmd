...
# Classify as White
cbdata$race___6 <- ifelse(cbdata$otherrace == "6" | cbdata$otherrace == "asianandwhite" |
                          cbdata$otherrace == "asiancaucasian" | 
                          cbdata$otherrace == "asianwhite" |
                          cbdata$otherrace == "blackandwhite" |
                          cbdata$otherrace == "blackhawaiianwhite" |
                          cbdata$otherrace == "britishasian" |
                          cbdata$otherrace == "chineseeuropean" |
                          cbdata$otherrace == "europeanlatin" |
                          cbdata$otherrace == "europeanspanishandportuguese" |
                          cbdata$otherrace == "halfcaucasianhalfsouthasian" |
                          cbdata$otherrace == "halfwhiteblack" |
                          cbdata$otherrace == "mixedchinesewhite" |
                          cbdata$otherrace == "mixedracenigerianandwhite" |
                          cbdata$otherrace == "mixedwhitecaucasiankorean" |
                          cbdata$otherrace == "mixofcaucasianfirstnationsandblack" |
                          cbdata$otherrace == "polishandpakistani" |
                          cbdata$otherrace == "whiteandasian" |
                          cbdata$otherrace == "whiteasian" |
                          cbdata$otherrace == "whitenative" |
                          cbdata$otherrace == "dutch14moroccan", 1, cbdata$race___6)
