...
# selecting columns to keep in range 1-120,161-200
```{r}
...
"medicalhistorybaby___22", "medicalhistorybaby___14", "medicalhistorybaby___5", "medicalhistorybaby___6")]
```
```{r}
cbdata[,c("deaf","deaf1","risk_score_ASD","asdfamily_gma","asdfamily_gpa","ddfamily_grandmother","otherszbpfamilymember_grandfather","otherszbpfamilymember_grandmother"    
,"whichmedsforbaby_arm","unusualmovements","unusual_actions_nonagressive","unusual_actions_aggressive","otherbehaviors_delayed_milestones","otherbehaviors_behavioral_abnormalities","otherbehaviors_body_function_abnormalities","otherbehaviors_familyhistory_otherdiagnoses","babyageyrs")]
```
