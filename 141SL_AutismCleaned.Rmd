...
# Adding Baby Age in Years Variable: 5 years as cut off
```{r}
babyageyrs = round(cbdata$babyage / 365, 1)
cbdata$babyageyrs = babyageyrs
# babyageyrs[which(babyageyrs <= 5)]
```

# Baby Weight: 45 lbs as cut off

```{r}
# cbdata$babysweightlbs[cbdata$babysweightlbs <= 45]
```
