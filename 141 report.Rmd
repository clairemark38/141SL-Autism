...
As a start point for exploratory data analysis, literature review revealed that there are certain factors that increase a child’s risk for autism spectrum disorder: child’s sex, family history, other disorders present in the child, extremely preterm babies, and the parents’ delivery ages. Males are four times more likely than females to get autism. A child’s risk for autism spectrum disorder increases if a relative, such as a sibling, parent, cousin, etc., has already been diagnosed with the disorder. Pre-existing health conditions such as fragile X syndrome, tuberous sclerosis, and Rett syndrome, also increase a baby’s risk. Babies born before 26 weeks of gestation are at higher risk compared to those born later. Finally, children born to older parents at the time of delivery are at higher risk for autism spectrum disorder compared to those born to younger parents.
To look further into some of these potential risk factors, boxplots were created to explore the relationships of these factors with a child’s risk score for ASD.
[insert code for box plots here, change the codes to ggplot2]
Aside from the factors indicated by literature review, a correlation plot was created to examine if any of the at-risk behaviors were correlated with each other. It turned out that many of them in fact were correlated. If a child had a certain at-risk behavior, it was also likely that he or she had another.
[insert code for correlation plot here, change the code to ggplot2]
(discuss drugs vs risk scores)
[insert code for box plots and jitter plots]
Correlation for maternal mental health
