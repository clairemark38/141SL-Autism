...
data$momlivebirths[which((is.na(data$momlivebirths) == TRUE) &
                           (data$totalpregnancies == (data$birthordertotal + 1)))] <-
  data$totalpregnancies[which((is.na(data$momlivebirths) == TRUE) & 
                                (data$totalpregnancies == (data$birthordertotal + 1)))]
...
data$momlivebirths[which((is.na(data$momlivebirths) == TRUE) &
                           (data$totalpregnancies == (data$numberfullsiblings + 1)))] <-
  data$totalpregnancies[which((is.na(data$momlivebirths) == TRUE) & 
                                (data$totalpregnancies == (data$numberfullsiblings + 1)))]
...
data$momlivebirths[which((is.na(data$momlivebirths) == TRUE) & 
                           (data$totalpregnancies > data$numberfullsiblings) &
                           data$olderhalfsiblings == 0 )] <-
  data$numberfullsiblings[which((is.na(data$momlivebirths) == TRUE) & 
                                  (data$totalpregnancies > data$numberfullsiblings) &
                                  data$olderhalfsiblings == 0 )] + 1
```
