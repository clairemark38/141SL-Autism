...
data$unusualmovements <- ifelse(rownames(data)%in%unusualmovements, 1, 0)
...
data$unusual_actions_nonagressive <- ifelse(rownames(data)%in%unusual_actions_nonagressive, 1, 0)
...
data$unusual_actions_aggressive <- ifelse(rownames(data)%in%unusual_actions_aggressive, 1, 0)
...
data$otherbehaviors_delayed_milestones <- ifelse(rownames(data)%in%otherbehaviors_delayed_milestones, 1, 0)
...
data$otherbehaviors_behavioral_abnormalities <- ifelse(rownames(data)%in%otherbehaviors_behavioral_abnormalities, 1, 0)
...
data$otherbehaviors_body_function_abnormalities <- ifelse(rownames(data)%in%otherbehaviors_body_function_abnormalities, 1, 0)
...
otherbehaviors_familyhistory_otherdiagnoses <- c(21, 448, 695, 712, 941, 1074, 1083, 1468, 1683, 1902, 1936, 1958, 2007,
                                                 205, 2079, 2435, 2567)
data$otherbehaviors_familyhistory_otherdiagnoses <- ifelse(rownames(data)%in%otherbehaviors_familyhistory_otherdiagnoses, 1, 0)
