...
# creating values for the rest of the others, and replacing all NA's with 0
cbdata$maternalpregnancyproblems_other <- ifelse(is.na(cbdata$maternalpregnancyproblems_other), 0, 1)
# or 
