...
# remove observation where ddfamily, szbpfamily, deaf, asd, total preganancies, momlivebirth all equal 8 and momsdeliveryage equals 12
```{r}
predata <- predata %>% filter(ddfamily != 8 & szbpfamily !=8 & deaf !=8 & asd != 8)
```
